...
$r=$con->query("INSERT INTO `add_cart`(`ac_id`, `c_id`, `cat_id`, `cat_name`, `p_id`, `p_name`, `p_mrp`, `p_dp`, `p_qty`, `p_total`,`date`, `time`) VALUES (NULL,'$d_detail[c_id]','$res1[cat_id]','$res1[cat_name]','$_GET[id]','$res[name]','$res[mrp]','$res[dp]','$p_qty','$res[dp]','$date','$time');");
