...
if(isset($_POST[ad_cat])){
    ...
    $hg="INSERT INTO `product`(`p_id`, `cat_id`, `unq_id`, `p_type`, `name`, `image1`, `image2`, `mrp`, `dp`, `qty`, `short_description`, `long_description`, `date`, `time`) VALUES (NULL,'$cid','$unq','$ptype','$name','$img1','','$mrp','$dp','$qty','$sd','$ls','$date','$time')";
    // $hg="INSERT INTO `product`(`p_id`, `cat_id`, `unq_id`,`p_type`, `name`, `image1`,  `mrp`, `dp`, `qty`, `short_description`, `long_description`, `date`, `time`) VALUES (NULL,'$cid','$unq','$ptype',$name','$img1','$mrp','$dp','$qty','$sd','$ls','$date','$time');";
