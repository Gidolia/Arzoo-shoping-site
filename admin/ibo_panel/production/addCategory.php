...
/////////////////////// end Enter New Category///////////////////////////
    ...
    if(isset($_POST['ad_cat']))
    {
        ...
        if(move_uploaded_file($_FILES['img']['tmp_name'], "images/cat".$unqid.".jpg") AND move_uploaded_file($_FILES['img1']['tmp_name'], "images/banner".$unqid.".jpg"))
		{
            ...
            $rf="INSERT INTO `category`(`id`, `cat_name`, `cat_image`, `banner_image`, `unq_id`, `cat_id`) VALUES ('null','$category','$file','$file1','$unqid','$hfuy')";
    ...
    ?>
        ...
        <table class="table table-striped table-bordered table-responsive" id="datatable">
            <thead><tr><th>S.No</th><th>Name</th><th>Images</th><th>Banner</th><th>Action</th></tr></thead>
            <?php
            $a=0;
            ...
            <tr>
                ...
                <?php echo $d['image'];?></th>
                <th><img src="./images/<?php echo $d['banner_image'];?>" height="70px" weight="70px">
                <?php echo $d['image'];?></th>
