							...
							<div class="tab-content">
							    ...
							    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
							    	<form method="post">
							    		...
							    		<div class="form-group">
							    			<label for="register-email-2">Your Email*</label>
							    		...
							    		<div class="form-group">
							    			<label for="register-email-2">Your Gender*</label>
                                ...
                                <option value="Female">Female</option>
							    		...
							    		<div class="form-group">
							    			<label for="register-email-2">Create Password*</label>
							    			<input type="number" class="form-control"  name="password" required>
							    		</div>
							    		<div class="form-footer">
							    			<button type="submit" class="btn btn-outline-primary-2" name="btn_reg">
			                					<span>REGISTER</span>
